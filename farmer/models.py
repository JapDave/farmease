...
class Farmer(models.Model):
    ...
    profile_photo = models.ImageField(("Profile Photo"), upload_to='farmer/photo',validators=[FileExtensionValidator(['jpg','jpeg','png','webp'])],height_field=None, width_field=None, max_length=None)
    profile_video = models.FileField(("Profile Video"), upload_to='farmer/video',validators=[FileExtensionValidator(['mp4','mov','avi','webm'])],default="")
